"""Bayesian conditioning of pair collision probability.

Phase 3 of the probcol roadmap. The standard ISCWSA pair-probability
calculation assumes the two wells' position-error vectors are entirely
...
def combine_covariances(
    ...
    *,
    ...
    if share_mode == "all_independent":
        ...
        # geometric mean of the two as a robust shared estimate.
        shared = 0.5 * (gA + gB)
