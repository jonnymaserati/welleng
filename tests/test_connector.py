...
# test that a mesh can be generated from the survey data
c5_mesh = we.mesh.WellMesh(c5_survey, method='circle')

# test with pos2, inc1 and azi1 provided ()
c6 = we.connector.Connector(
    pos1=[0.,0.,0],
    inc1=0.,
    azi1=90,
    pos2=[1000.,1000.,1000.],
