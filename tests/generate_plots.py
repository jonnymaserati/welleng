...
# exclude_files = ['error-model-example-mwdrev5-1-iscwsa-1.xlsx',
#                  'error-model-example-mwdrev5-1-iscwsa-2.xlsx',
#                  'error-model-example-mwdrev5-1-iscwsa-3.xlsx']
...
for tab in list_of_errors_csv:
    ...
    # if ISCWSA_file_name not in exclude_files:
    #     if tab == 'XCLL':
    #         tab = 'XCLA'
    ...
    # in the cov_per_error_test_2 and 3 there is XCLL csv file
    # if ISCWSA_file_name not in exclude_files:
    #     if tab == 'XCLA':
    #         tab = 'XCLL'
